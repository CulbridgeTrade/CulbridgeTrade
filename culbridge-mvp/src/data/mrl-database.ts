...
export const EU_MRL_DATABASE: MRLRecord[] = [
  // === SESAME SEEDS ===
  {
...
export function lookupMRL(chemical: string, commodity: string | null): MRLRecord | null {
  if (!commodity) {
    return EU_MRL_DATABASE.find(r => 
      r.chemical === chemical && r.commodity === "all"
    ) ?? null;
  }
...
export default EU_MRL_DATABASE;
