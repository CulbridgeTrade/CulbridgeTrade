...
import { RASFF_ALERTS, checkRASFFMatch } from "../data/rasff-alerts.js";
...
function getRequiredDocuments(commodity, destination) {
  const docs = ["phytosanitary_certificate"];
  
  if (destination === "NL" || destination === "DE") {
